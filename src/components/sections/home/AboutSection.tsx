  ...
  return (
    <section className="about">
      ...
      <div className="about-text">
        <p>
          Six Foot is driven by faith, purpose, and partnership. We believe we were created to create—and to do so with strategic intent. Our role is to guide clients from one point to the next with clarity and confidence, through branding, advertising, illustration, and web design that genuinely serves their audience.
        </p>
        <p>
